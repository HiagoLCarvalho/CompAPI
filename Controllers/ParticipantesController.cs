    ...
    [HttpGet("{Id}")]
      public async Task<ActionResult> GetByIdAsync(int id)
      {
        ...
        using (IDbConnection conexao = ConnectionFactory.GetStringConexao(_config))
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.Append("SELECT ID as Id, ID_TIPO_PARTICIPANTE as TipoId, TX_NOME as Nome,TX_CPF as Cpf, TX_Email as Email " );
            sql.Append("FROM TB_PARTICIPANTE WHERE ID = @Id " );
     ...
     public async Task<ActionResult> UpdateAsync(Participante p)
     {
         using (IDbConnection conexao = ConnectionFactory.GetStringConexao(_config))
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.Append("UPDATE TB_PARTICIPANTE " );
